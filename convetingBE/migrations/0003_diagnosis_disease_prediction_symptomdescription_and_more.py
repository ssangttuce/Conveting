...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('convetingBE', '0002_rename_diagnosissubmission_diagnosissubmit_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='seq',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='convetingBE.symptomdescription'),
        ),
        migrations.AddField(
            model_name='diagnosis',
            name='disease',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='convetingBE.disease'),
        ),
        migrations.AddField(
            model_name='diagnosis',
            name='seq',
